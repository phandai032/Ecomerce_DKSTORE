          ...
          <div class="col-lg-9 main-chart">
            ...
            <form action="#" method="get">
              <div class="border-head">
                <div class="col-lg-4"><h3>QUẢN LÝ KHO</h3></div>
                <div class="col-lg-3"></div>
                <div class="col-lg-5"></div>
              </div>
            </form>
            <div class="row">
              <img src="../images/stock.png" class="col-lg-12" alt="" sizes="" srcset="">
            </div>
            <!--custom chart end-->
            <div class="row mt">
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="row">
              <div class="col-lg-12 col-sm-12">
                <div class="weather">
                  <h3><a href="#">Đơn hàng đã xử lý</a></h3>
            ...
            <div class="row">
              <div class="col-lg-12 col-sm-12">
                <div class="weather">
                  <h3><a href="#">Đơn hàng đã chuẩn bị</a></h3>
                  <h2><?php echo $p->exportNumOrder("select count(ID_DH) from donhang where TrangThai = 1 or TrangThai=2"); ?> <i class="fa fa-shopping-bag"></i></h2>
                </div>
              </div>
            </div>
