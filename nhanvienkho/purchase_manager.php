    ...
    <?php
      switch ($_REQUEST["button"]) {
        ...
        case 'create':{
          ...
          $p->Interactive("INSERT INTO `donmuahang` ( `Date`, `TongDon`, `ID_NV`, `ThuGui`, `ThuNhan`, `TrangThai`) VALUES (NOW(), $TongTien, $id_nv, '', '', 1)");
          ...
          echo'<script>alert("Create purchase order success!!!"); history.go(-1); </script>';
          break;
        }
