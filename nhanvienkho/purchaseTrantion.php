                ...
                <section class="bg12 col-lg-12">
                  <div class="flex-w flex-sb-m">
                    <form class="flex-w flex-l-m filter-tope-group m-tb-10">
                      <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" name="id" value="2">
                      Đơn mua hàng đang chờ nhận
                      </button>
                      <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" name="id" value="3">
                      Đơn mua hàng đã nhận 
                      </button>
                    </form>
                  </div>
                      ...
                      <?php
                        ...
                        if($id!=''){
                          if($id == 2 || $id == 3 || $id == 4) {
                            ...
                            echo '<script>alert("Không tìm thấy!");history.go(-1);</script>';
                          } 
                        }else{
                          $_SESSION['po']=2;
                          $read->readPuschase("http://localhostphp/api/exportPurchase.php?id=2"); 
                        }
                      ?>
                  </div>
                </section>
