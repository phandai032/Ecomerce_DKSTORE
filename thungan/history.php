          ...
          <div class="col-lg-9 main-chart">
            ...
            <form action="#" method="get">
              <div class="border-head">
                <div class="col-lg-5"><h3>Lịch sử giao dịch</h3></div>
            ...
            <div class="row" >
                <section class="bg12 col-lg-12">
                  ...
                  <div class="row bor21 isotope-grid" style="overflow-y: scroll; height: 502px;" id="myList">
                      <?php
                        $mand = $_SESSION['maND'];
                         $read->readHistory_TN("http://localhostphp/api/exportorder.php?mand=$mand"); 
                      ?>
                  </div>
                </section>
              </div>
                    ...
                    <div class="header-cart-wrapitem w-full scoll-cart">
                      <?php
                        switch ($_REQUEST['button']) {
                          case 'see':{
                            $id = $_REQUEST['id'];
                            $read->readorderdetail_TN("http://localhostphp/api/exportdetail.php?id=$id&nd=3");
                            break;
                          }
                          case 'cancel':{
      ...
      switch ($_REQUEST["button"]) {
        ...
        case 'apply':
        {
          ...
          if($voucher){
            ...
            echo '<script>alert ("You need to enter the voucher!!!"); history.go(-1);</script>';
          }
          break;
        }
        case 'checkout':
        {
          ...
          $id_nd = $_SESSION['maND'];
          $p->Interactive("INSERT INTO `donhang` (`TrangThai`, `NgayLap`, `TongDon`,`HinhThucThanhToan`, `Voucher`, `ID_DCGH`, `ID_ND`) VALUES (5,NOW(),$tongtien,1,'$voucher',0,$id_nd)");
