                        ...
                        <table class="table-shopping-cart table ">
                          <?php
                            if(isset($_REQUEST["dh"])){
                              $dh = $_REQUEST["dh"];
                              if($dh == 0){
                                $read->ReadOrderAdmin('http://localhostphp/api/exportorder.php?dh=0');
                              }else{
                                $read->ReadOrderAdmin('http://localhostphp/api/exportorder.php?dh='.$dh.'');
                              }
                            }else{
                              $read->ReadOrderAdmin('http://localhostphp/api/exportorder.php');
                            }
                          ?>
                        </table>
                      </div>
