            ...
            <div class="col-lg-3 ds">
              <!-- First Activity -->
                <div id="trang" class="desc">
                    ...
                    <button id="btn1" type="submit" name="btn" value="add" class="btn btn-info col-lg-12">Tạo tin tức</button>
                    <button id="btn2" type="submit" name="btn" value="add_new" class="btn btn-info m-t-10 col-lg-12">Thêm</button>
                    <button id="btn4" name="btn" value="edit" class="btn btn-info col-lg-12 m-t-10">Chỉnh sửa tin tức</button>
                    <?php
                      $_SESSION['id']=$id;
                      $k = $p->exportNumOrder('SELECT TrangThai as ID_DH FROM blog where ID_BV = "'.$id.'"');
                      if($k == 0){
                        echo '<button id="btn5" type="submit" name="btn" value="public" class="btn btn-info  m-t-10 col-lg-12">Công khai</button>';
                      }else{
                        echo '<button id="btn5" type="submit" name="btn" value="private" class="btn btn-info m-t-10 col-lg-12">Ẩn</button>';
                      }
                    ?>
