          ...
          <div class="col-lg-9 main-chart">
            ...
            <form action="#" method="get">
              <div class="border-head">
                <div class="col-lg-2"><h3>Bảng điều khiển</h3></div>
                  ...
                  <div>
                    ...
                    <div class="col-lg-4 bor20">
                          ...
                          <div class="col-lg-8  m-t-10 m-b-10">
                              <div class="row"><span>Họ tên: Phan Dai</span></div>
                              <div class="row"><span>Tổng tiền: 100000000000 VND</span></div>
                              <div class="row"><span>Số đơn: 12 Đơn</span></div>
                              <div class="row">
