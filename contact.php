...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img10 txt-center p-lr-15 p-tb-92" style="background-image: url('images/banner.png');">
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form method="POST" enctype="multipart/form-data">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="email" placeholder="Địa chỉ thư của bạn">
							<img class="how-pos4 pointer-none" src="images/icons/icon-email.png" alt="ICON">
						</div>

						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="msg" placeholder="Vấn đề bạn cần chúng tôi giúp đỡ là gì ?"></textarea>
						</div>

						<button name="send" value="send" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
								...
								case 'send':
									{
										...
										$mail->Subject = "YEU CAU HO TRO TU KHACH HANG";
										$MESSAGER = 'Bạn đã để lại yêu cầu :<p style="color: blue;">'.$_POST['msg'].'</p>.</br>DK-STORE sẽ liên hệ lại cho bạn ngay khi xem được yêu cầu này.</br> Cảm ơn bạn đã quan tâm!';
										$mail->Body = $MESSAGER;
										$mail->AddAddress($tmail);
										$time = date('H:i d-m-Y');
										if(!$mail->Send()) {
											echo '<script>alert("Yêu cầu hỗ trợ của bạn gửi không thành công"); window.location.replace("http://localhostcontact.php");</script>';
										} else {
											echo '<script>alert("Yêu cầu hỗ trợ của bạn đã gửi thành công"); window.location.replace("http://localhostcontact.php");</script>';
										}
										break;
									}
							}
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">
								334 Chu Van An, Phuong 12, Binh Thanh, Ho Chi Minh
							</p>
						</div>
					</div>
	...
	<!-- Map -->
	<div class="map">
		<div class="size-303" id="google_map" data-map-x="10.8222053" data-map-y="106.6853107" data-pin="images/icons/tag.png" data-scrollwhell="0" data-draggable="1" data-zoom="11"></div>
	</div>
	<!-- Footer -->
	<!-- Footer -->
