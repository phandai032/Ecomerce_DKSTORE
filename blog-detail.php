...
<body class="animsition">
	...
	<section>
		...
		<?php
				...
				$sta = $_REQUEST['sta'];
				if($sta == 1){
					$read->event9('http://localhostphp/api/exportEvent.php?id='.$id.'');
				}else{
					$read->event10('http://localhostphp/api/exportEvent.php?id='.$id.'');
				}
			?>
		</div>
	</section>	
...
<!--===============================================================================================-->
	<script>
		function coppy(){
			if(navigator.clipboard.writeText($("#copyArea").val())){
