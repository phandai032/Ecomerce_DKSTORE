          ...
          <div class="col-lg-9 main-chart">
            <div class="row" >
                <section class="bg12 col-lg-12">
                  ...
                  <div id="btn8" class="col-lg-12  text-center bg11 p-tb-10">
                    <div class="col-lg-1">#</div>
                    <div class="col-lg-2">Mã giảm giá</div>
                    <div class="col-lg-1">Khuyến mãi</div>
                    <div class="col-lg-1">số lần dùng</div>
                    <div class="col-lg-2">Ngày bắt đầu</div>
                    <div class="col-lg-2">Ngày kết thúc</div>
                    <div class="col-lg-3">Thao tác</div>
                  </div>
            ...
            <div class="col-lg-3 ds">
              <!-- First Activity -->
                <form id="trang" class="desc">
                    ...
                    <button id="btn1" type="submit" name="btn" value="add" class="btn btn-info col-lg-12">Tạo mã giảm giá</button>
