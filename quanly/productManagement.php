            ...
            <div class="col-lg-3 ds">
              <!-- First Activity -->
                <form id="trang" class="desc">
                    ...
                    <button id="btn1" name="button" value="add" class="btn btn-info col-lg-12">Tạo sản phẩm mới</button>
                    <button id="btn4" name="button" value="edit" class="btn btn-info col-lg-12 m-t-10">Chỉnh sửa</button>
                    <button id="btn5" name="button" value="add_ver" class="btn btn-info col-lg-12 m-t-10">Tạo phiên bản</button>
